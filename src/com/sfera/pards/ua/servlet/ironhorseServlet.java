...
/**
 * Servlet implementation class ironhorseServlet
 */
@WebServlet("/ironhorse")
public class ironhorseServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("pages/ironhorse.jsp").forward(request, response);
	}
