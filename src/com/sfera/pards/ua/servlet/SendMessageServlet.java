...
//
//	public void sendMail(String theme, String mailBody, String email, String phone, String message1, String phone2) {
...
//			message.setContent("name:" + " " + mailBody + "<br/>" + "phone:" + phone2 + "<br/>" + "text:" + message1+"<br/>"
