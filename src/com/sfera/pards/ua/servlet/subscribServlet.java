...
/**
 * Servlet implementation class SubscribServlet
 */
@WebServlet("/subscrib")
public class subscribServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("pages/subscrib.jsp").forward(request, response);
	}
