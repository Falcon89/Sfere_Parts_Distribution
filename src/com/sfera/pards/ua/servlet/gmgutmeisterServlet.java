 ...
 */
@WebServlet("/gmgutmeister")
public class gmgutmeisterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("pages/gmgutmeister.jsp").forward(request, response);
	}
