...
/**
 * Servlet implementation class cleveroServlet
 */
@WebServlet("/clevero")
public class cleveroServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("pages/clevero.jsp").forward(request, response);
	}
