...
/**
 * Servlet implementation class tissenServlet
 */
@WebServlet("/tissen")
public class tissenServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("pages/tissen.jsp").forward(request, response);
	}
