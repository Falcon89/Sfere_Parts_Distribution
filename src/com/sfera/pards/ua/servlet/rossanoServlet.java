...
/**
 * Servlet implementation class rossanoServlet
 */
@WebServlet("/rossano")
public class rossanoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("pages/rossano.jsp").forward(request, response);
