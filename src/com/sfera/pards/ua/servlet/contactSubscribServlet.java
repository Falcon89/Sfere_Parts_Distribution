 ...
 */
@WebServlet("/contactSubscrib")
public class contactSubscribServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("pages/contactSubscrib.jsp").forward(request, response);
	}
