					...
					<div class="col-md-8 col-lg-8 col-xs-12 galer">
						<div id="gallery">
							...
							<div id="thumbs" class="rhn">
								<input width="23%" type="image" class="img" value="colour1" src="pages/img/katalog/logs/aigner.png" /> 
									<input width="23%" type="image" class="img" value="colour2" src="pages/img/katalog/logs/meyer.png" /> 
									<input width="23%" type="image" class="img" value="colour3" src="pages/img/katalog/logs/iron_horse.png" /> 
									<input width="23%" type="image" class="img" value="colour4" src="pages/img/katalog/logs/sp_tr.png" /> 
									<input width="23%" type="image" class="img" value="colour5" src="pages/img/katalog/logs/rossano.png" /> 
									<input width="23%" type="image" class="img" value="colour6" src="pages/img/katalog/logs/clever_oil.png" /> 
									<input width="23%" type="image" class="img" value="colour7" src="pages/img/katalog/logs/tissen.png" /> 
									<input width="23%" type="image" class="img" value="colour8" src="pages/img/katalog/logs/clever-fil.png" /> 
									<input width="23%" type="image" class="img" value="colour9" src="pages/img/katalog/logs/bredl.png" />
									<input width="23%" type="image" class="img" value="colour10" src="pages/img/katalog/Gm_baner.png" />
							</div>
						</div>
					</div>
	...
	<script>
		...
		function change() {
			...
			case "colour9":
				...
				break;
			case "colour10":
				image = '<a target="_blank" href="${pageContext.servletContext.contextPath}/gmgutmeister"><img src="pages/img/katalog/logs/smol_banners/gm_index.jpg"></img></a>';
				break;
			default:
				image = '<img src="#!"></img>';
			}
